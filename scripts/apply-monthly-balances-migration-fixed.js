...
async function applyMonthlyBalancesMigrationFixed() {
  console.log('🔧 Aplicando migración de monthly_balances (versión corregida)...\n');
  ...
  try {
    ...
    const migrationSQL = `
      ...
      -- Administradores pueden ver y modificar todos los balances (usando auth.users)
...
applyMonthlyBalancesMigrationFixed(); 